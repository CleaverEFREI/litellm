...
_title = os.getenv("DOCS_TITLE", "MH Edition LiteLLM API")
_description = os.getenv(
    "DOCS_DESCRIPTION",
    f"Malakoff Humanis Edition \n\nServeur proxy pour appeler plus de 100 LLM au format OpenAI. {custom_swagger_message}\n\n{ui_message}",
)
...
async def completion(  # noqa: PLR0915
    ...
    ```bash
    curl -X POST http://localhost:4000/completions \
...
async def model_info_v2(
    ...
    """
    BETA ENDPOINT. Might change unexpectedly. Use `/model/info` for now.
    """
